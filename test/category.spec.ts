...
contract("CategoryContract", async (accounts) => {
    ...
    describe("#createVotingContract", async () => {
        context("when not called via ManagerContract", async () => {
    ...
    context("For category with one voting", async () => {
        describe("#numberOfContracts", async () => {
            it("returns 1", async () => {
        ...
        describe("#votingContracts(0)", async () => {
            it("returns first (and only) voting contract", async () => {
        ...
        describe("#votingContracts(1)", async () => {
    ...
    context("After adding second voting", async () => {
        before(async () => {
        ...
        describe("#votingContracts", async () => {
            it("returns both votingContracts correctly", async () => {
